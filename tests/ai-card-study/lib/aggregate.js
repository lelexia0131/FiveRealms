...
import { ROLE_CARD_VALUE_DELTAS } from "../../../js/ai/roleCardValue.js";
...
async function writeReport(results, holdByCardStratum) {
  ...
  lines.push("| roleCardValue.js | getBaseCardAiValue | 读取基础值 | 基础值 | 无 | 否 | 否 | 否 | 否 |");
  lines.push("| roleCardValue.js | getRoleCardAiValue | 角色有效值 = 基础 + 差值 | 角色值 | 无 | 是 | 是 | 是 | 是 |");
  ...
  lines.push("| AiCardSelector | chooseDiscards / choosePublicCard / chooseHiddenCards | 弃牌、公共牌、隐藏选牌 | 角色值 | 有（调息/格挡/共生/孤立突袭） | 否 | 是 | 是 | 否 |");
