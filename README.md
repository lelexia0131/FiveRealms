...
守誓者最大生命为 3。主动技能“壁垒”消耗 2 点能量，为一名存活队友提供 1 点临时护盾；壁垒护盾可以叠加，剩余层数会在目标自己的下回合开始时统一消散。
...
- **背景势力／生命：** 曜石城垒／3 点生命。
- **定位：** 防御、保护。能在伤害落下前保护队友，并用临时护盾维持阵线。
- **人物描述：** 背负古誓的城垒守卫，擅长将危险拦截在盟友身前。
- **被动·护援：** 队友即将受到伤害时，可以弃置 1 张手牌令该次伤害减少 1 点；每轮限触发 1 次。
- **主动·壁垒：** 消耗 2 点能量，使一名存活队友获得 1 点可叠加的壁垒护盾；剩余壁垒护盾在该队友的下回合开始时消散，一回合最多使用 2 次。
