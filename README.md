...
- **背景势力／生命：** 雾泉庭／4 点生命。
- **定位：** 恢复、辅助。通过每回合第一次实际治疗获得额外手牌，也能以较低能量连续救治受伤角色。
- **人物描述：** 听见生命回声的游医，以自己的元息换取同伴继续作战。
- **被动·回春：** 每回合第一次由自己使自己或队友实际恢复生命时，摸 1 张牌；濒死救援也可以触发。
- **主动·滋荣：** 消耗 1 点能量，使自己或一名受伤队友恢复 1 点生命。一回合最多使用 2 次。
...
5. 每张「调息」恢复 1 点生命并触发 `dyingRescueUsed`；若灵医本回合首次以「调息」使自己或队友实际恢复生命，「回春」会令灵医摸 1 张牌。目标生命仍不大于 0 时重新开始一轮询问。
