...
- **主动·壁垒：** 消耗 2 点能量，使一名存活队友获得 1 点壁垒护盾，一回合最多使用 2 次。

### 灵医

- **背景势力／生命：** 雾泉庭／3 点生命。
- **定位：** 恢复、辅助。通过强化每回合第一次常规治疗提高资源效率，也能牺牲自己的生命集中救治队友。
...
- **背景势力／生命：** 镜轮市／4 点生命。
- **定位：** 风险、随机。通过战术牌触发高收益或资源损失，并把积累的能量一次押在过牌与突袭强化上。
...
合计：基础牌 85、战术牌 40、装备牌 8，共 133 张。每个实体具有唯一 `card.id`；配置与规则使用稳定 `definitionId`。
...
- 充能：获得 1 点能量，不超过上限。
- 护盾：选择自己或任意一名存活队友，使其获得 1 点护盾；护盾可叠加且不会在回合开始时归零。
...
- `AiKnowledge`：从 133 张组成减去公开/合法已知牌，采样 10 个隐藏世界。
