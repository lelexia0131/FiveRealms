...
- **背景势力／生命／初始能量：** 无灯港／4 点生命／0 点能量。
- **定位：** 控制、辅助。通过伤害建立私密手牌情报，再直接窃取敌人的隐藏资源。
- **人物描述：** 往返暗潮市集的情报客，相信一张被看见的牌就不再是秘密。
- **被动·窥隙：** 每回合首次对敌人造成实际伤害后，私下选择并查看该敌人至多 2 张手牌。
- **主动·窃取：** 消耗 2 点能量，选择距离 2 内一名持有手牌或装备的敌人作为目标，把该敌人的全部手牌实体与当前装备实体组成统一候选集合，等概率随机获得其中 1 张并收入手牌，一回合最多使用 2 次。
...
- 雷达：当需要打出「格挡」进行响应时公开判定。战术牌进入弃牌堆并令此次攻击无效；基础牌进入防守者手牌后继续结算，新获得的「格挡」可立即响应；装备牌进入弃牌堆，此次攻击继续进入「格挡」、护盾和伤害结算。
