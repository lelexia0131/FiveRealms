...
const definitions = [
  ...
  { id: "executioner_turn", tier: "epic", hidden: false, title: "两刃同落", description: "同一个行动回合，两个破绽被你接连捕捉。", criteria: "同一行动回合连续击杀 2 名敌人。", teamScope: "both", order: 2, artwork: artwork("executioner_turn") },
  ...
  { id: "storm_scribe", tier: "hidden", hidden: true, title: "雷鸣两度", description: "闪电掠过敌阵，留下两道无法忽视的回声。", criteria: "单场主动打出至少 2 次闪电，且两次都实际对敌人造成闪电伤害。", teamScope: "both", order: 1, artwork: artwork("storm_scribe") },
