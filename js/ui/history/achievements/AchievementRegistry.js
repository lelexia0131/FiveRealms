...
const definitions = [
  ...
  { id: "lavish_discard", tier: "epic", hidden: false, title: "挥金如土", description: "牌页如金雨散落，下一步早已不在掌中。", criteria: "你的一回合弃牌超过 5 张", teamScope: "both", order: 11, artwork: artwork("lavish_discard") },
  { id: "shadow_collector", tier: "epic", hidden: false, title: "拾喽", description: "暗巷的风掠过指尖，别人的底牌已随你远行。", criteria: "使用影客一局游戏通过窃取获得 6 张牌", teamScope: "both", order: 12, artwork: artwork("shadow_collector") },
  { id: "healing_angel", tier: "epic", hidden: false, title: "天使", description: "雾泉升起微光，伤口深处再次生出春天。", criteria: "使用灵医一局游戏通过滋荣治疗 6 滴血", teamScope: "both", order: 13, artwork: artwork("healing_angel") },
  { id: "fate_gambler", tier: "epic", hidden: false, title: "赌徒", description: "命运数次收拢掌心，你仍将一切推向桌前。", criteria: "使用赌命者一局游戏 5 次进入孤注状态", teamScope: "both", order: 14, artwork: artwork("fate_gambler") },
