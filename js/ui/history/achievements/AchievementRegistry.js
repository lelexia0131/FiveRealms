...
const definitions = [
  ...
  { id: "rescue_chain", tier: "rare", hidden: false, title: "接住第二次", description: "救援不靠侥幸，连续伸出的手把阵线稳住。", criteria: "单场成功救下至少 2 名濒死友军。", teamScope: "both", order: 3, artwork: artwork("rescue_chain") },
  { id: "heavy_blow", tier: "rare", hidden: false, title: "一击裂甲", description: "一次完整行动足以让最硬的防线失去形状。", criteria: "单个行动回合实际造成至少 3 点生命伤害。", teamScope: "both", order: 4, artwork: artwork("heavy_blow") },
  ...
  { id: "single_punch", tier: "rare", hidden: false, title: "一拳", description: "一记落下，护甲与空气一同发出裂响。", criteria: "打出的一次攻击造成至少 3 点实际生命伤害。", teamScope: "both", order: 10, artwork: artwork("single_punch") },
  ...
  { id: "rescue_master", tier: "epic", hidden: false, title: "三次回生", description: "三次从濒死边缘拉回同伴，援护变成了传说。", criteria: "单场成功救下至少 3 名濒死友军。", teamScope: "both", order: 4, artwork: artwork("rescue_master") },
  { id: "ace", tier: "epic", hidden: false, title: "ACE", description: "三枚敌方徽记被你亲手从战场上抹去。", criteria: "二人小队中单场由真人玩家本人击杀 3 名敌人。", teamScope: "duo", order: 5, artwork: artwork("ace") },
  ...
  { id: "serious_punch", tier: "legendary", hidden: false, title: "认真的一拳", description: "这一击的回声穿过整座战场，连岩壁都为之震动。", criteria: "打出的一次攻击造成至少 5 点实际生命伤害。", teamScope: "both", order: 5, artwork: artwork("serious_punch") },
