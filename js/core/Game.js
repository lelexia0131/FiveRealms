 ...
 */
import { GAME_CONFIG, TEAM_CONFIG } from "../config/gameConfig.js?build=20260815-residual-end-threat-fix";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260815-residual-end-threat-fix";
import { createId, clamp } from "../utils/helpers.js?build=20260815-residual-end-threat-fix";
import { EventBus } from "./EventBus.js?build=20260815-residual-end-threat-fix";
import { Player } from "./Player.js?build=20260815-residual-end-threat-fix";
import { Deck } from "./Deck.js?build=20260815-residual-end-threat-fix";
import { TeamManager } from "./TeamManager.js?build=20260815-residual-end-threat-fix";
import { GeneralSelection } from "./GeneralSelection.js?build=20260815-residual-end-threat-fix";
import { RuleEngine } from "./RuleEngine.js?build=20260815-residual-end-threat-fix";
import { ResponseSystem, RESPONSE_STATUS, isCancelledResponse } from "./ResponseSystem.js?build=20260815-residual-end-threat-fix";
import { GameLogger } from "./GameLogger.js?build=20260815-residual-end-threat-fix";
import { resolveCardEffect } from "../cards/cardRegistry.js?build=20260815-residual-end-threat-fix";
import { getActiveSkill, getActiveSkillCost, registerPassiveSkills } from "../generals/skillRegistry.js?build=20260815-residual-end-threat-fix";
import { AIController } from "../ai/AiController.js?build=20260815-residual-end-threat-fix";
import { CleanupManager } from "../utils/CleanupManager.js?build=20260815-residual-end-threat-fix";
import { getAiDelay } from "../utils/aiTiming.js?build=20260815-residual-end-threat-fix";
import { Debug } from "../utils/debug.js?build=20260815-residual-end-threat-fix";
import { TeamRuleService } from "./TeamRuleService.js?build=20260815-residual-end-threat-fix";
import { DyingSystem } from "./DyingSystem.js?build=20260815-residual-end-threat-fix";
import { JudgmentSystem } from "./JudgmentSystem.js?build=20260815-residual-end-threat-fix";
import { CardSelectionSystem } from "./CardSelectionSystem.js?build=20260815-residual-end-threat-fix";
import { PublicCardPool } from "./PublicCardPool.js?build=20260815-residual-end-threat-fix";
import { HpLossSystem } from "./HpLossSystem.js?build=20260815-residual-end-threat-fix";
