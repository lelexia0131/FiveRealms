 ...
 */
import { GAME_CONFIG, TEAM_CONFIG } from "../config/gameConfig.js?build=20260810-root-provenance-v149";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260810-root-provenance-v149";
import { createId, clamp } from "../utils/helpers.js?build=20260810-root-provenance-v149";
import { EventBus } from "./EventBus.js?build=20260810-root-provenance-v149";
import { Player } from "./Player.js?build=20260810-root-provenance-v149";
import { Deck } from "./Deck.js?build=20260810-root-provenance-v149";
import { TeamManager } from "./TeamManager.js?build=20260810-root-provenance-v149";
import { GeneralSelection } from "./GeneralSelection.js?build=20260810-root-provenance-v149";
import { RuleEngine } from "./RuleEngine.js?build=20260810-root-provenance-v149";
import { ResponseSystem, RESPONSE_STATUS, isCancelledResponse } from "./ResponseSystem.js?build=20260810-root-provenance-v149";
import { GameLogger } from "./GameLogger.js?build=20260810-root-provenance-v149";
import { resolveCardEffect } from "../cards/cardRegistry.js?build=20260810-root-provenance-v149";
import { getActiveSkill, getActiveSkillCost, registerPassiveSkills } from "../generals/skillRegistry.js?build=20260810-root-provenance-v149";
import { AIController } from "../ai/AiController.js?build=20260810-root-provenance-v149";
import { CleanupManager } from "../utils/CleanupManager.js?build=20260810-root-provenance-v149";
...
import { TeamRuleService } from "./TeamRuleService.js?build=20260810-root-provenance-v149";
import { DyingSystem } from "./DyingSystem.js?build=20260810-root-provenance-v149";
import { JudgmentSystem } from "./JudgmentSystem.js?build=20260810-root-provenance-v149";
import { CardSelectionSystem } from "./CardSelectionSystem.js?build=20260810-root-provenance-v149";
import { PublicCardPool } from "./PublicCardPool.js?build=20260810-root-provenance-v149";
import { HpLossSystem } from "./HpLossSystem.js?build=20260810-root-provenance-v149";
