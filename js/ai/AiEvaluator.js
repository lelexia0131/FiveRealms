...
import { ThreatCalculator } from "./ThreatCalculator.js?build=20260731-async-session-v28";
import { assessGlobalBenefit } from "./AiGlobalBenefit.js?build=20260731-async-session-v28";
