...
import { buildRadarJudgmentProbabilities } from "./AiProbabilityBranches.js?build=20260810-guardian-aid-turn-v161";
import { ThreatCalculator } from "./ThreatCalculator.js?build=20260810-guardian-aid-turn-v161";
import { assessGlobalBenefit } from "./AiGlobalBenefit.js?build=20260810-guardian-aid-turn-v161";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260810-guardian-aid-turn-v161";
import { getBaseCardAiValue, getEquipmentKeepValueDeduction, getRoleCardAiValue } from "./roleCardValue.js?build=20260810-guardian-aid-turn-v161";
import { lightningTeamBurden, lightningUseValue } from "./lightningScoring.js?build=20260810-guardian-aid-turn-v161";
import {
  sealEarlyUsePenalty, sealTeamBurden, sealUseValue
} from "./sealScoring.js?build=20260810-guardian-aid-turn-v161";
