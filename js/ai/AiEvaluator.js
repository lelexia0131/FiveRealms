...
import { buildRadarJudgmentProbabilities } from "./AiProbabilityBranches.js?build=20260810-lightning-audio-loop-v160";
import { ThreatCalculator } from "./ThreatCalculator.js?build=20260810-lightning-audio-loop-v160";
import { assessGlobalBenefit } from "./AiGlobalBenefit.js?build=20260810-lightning-audio-loop-v160";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260810-lightning-audio-loop-v160";
import { getBaseCardAiValue, getEquipmentKeepValueDeduction, getRoleCardAiValue } from "./roleCardValue.js?build=20260810-lightning-audio-loop-v160";
import { lightningTeamBurden, lightningUseValue } from "./lightningScoring.js?build=20260810-lightning-audio-loop-v160";
import {
  sealEarlyUsePenalty, sealTeamBurden, sealUseValue
} from "./sealScoring.js?build=20260810-lightning-audio-loop-v160";
