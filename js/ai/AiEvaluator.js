...
import { buildRadarJudgmentProbabilities } from "./AiProbabilityBranches.js?build=20260809-momentum-log-fix-v130";
import { ThreatCalculator } from "./ThreatCalculator.js?build=20260809-momentum-log-fix-v130";
import { assessGlobalBenefit } from "./AiGlobalBenefit.js?build=20260809-momentum-log-fix-v130";
...
import { lightningTeamBurden, lightningUseValue } from "./lightningScoring.js?build=20260809-momentum-log-fix-v130";
import {
  sealEarlyUsePenalty, sealTeamBurden, sealUseValue
} from "./sealScoring.js?build=20260809-momentum-log-fix-v130";
