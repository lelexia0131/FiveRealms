...
import { TeamRuleService } from "../core/TeamRuleService.js?build=20260810-charge-threshold-v163";
...
export function createAiVisibleState(viewerId, state, remainingCardCounts = null) {
  ...
  return Object.freeze({
    ...
    players: state.players.map((player) => {
      ...
      initialEquipmentRoleDelta: player.equipment
        ? equipmentRoleDelta(player, player.equipment.definitionId)
        : 0,
      ...
      counterCountDistribution: counterEstimate.distribution,
