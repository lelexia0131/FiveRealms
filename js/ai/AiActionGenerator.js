...
import { getLightningStatusStateBranches } from "./lightningScoring.js?build=20260814-guardian-aid-certain-hand";
import { getSealStatusStateBranches } from "./sealScoring.js?build=20260814-guardian-aid-certain-hand";
import {
  ACTIVE_SKILLS, getActiveSkill, getActiveSkillCost
} from "../generals/skillRegistry.js?build=20260814-guardian-aid-certain-hand";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260814-guardian-aid-certain-hand";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260814-guardian-aid-certain-hand";
