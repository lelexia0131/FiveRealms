...
import { ACTIVE_SKILLS, getActiveSkill } from "../generals/skillRegistry.js?build=20260805-expose-weakness-response-v82";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260805-expose-weakness-response-v82";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260805-expose-weakness-response-v82";
