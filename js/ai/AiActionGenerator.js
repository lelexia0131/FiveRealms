...
import { ACTIVE_SKILLS, getActiveSkill } from "../generals/skillRegistry.js?build=20260801-audio-soft-v51";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260801-audio-soft-v51";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260801-audio-soft-v51";
