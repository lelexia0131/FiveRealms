...
import { ACTIVE_SKILLS, getActiveSkill } from "../generals/skillRegistry.js?build=20260804-target-selection-v58";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260804-target-selection-v58";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260804-target-selection-v58";
...
} from "./AiProbabilityBranches.js?build=20260804-target-selection-v58";
