...
import { getLightningStatusStateBranches } from "./lightningScoring.js?build=20260813-ai-hotpath-reuse";
import { getSealStatusStateBranches } from "./sealScoring.js?build=20260813-ai-hotpath-reuse";
import {
  ACTIVE_SKILLS, getActiveSkill, getActiveSkillCost
} from "../generals/skillRegistry.js?build=20260813-ai-hotpath-reuse";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260813-ai-hotpath-reuse";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260813-ai-hotpath-reuse";
