...
import { ACTIVE_SKILLS, getActiveSkill } from "../generals/skillRegistry.js?build=20260731-shade-svg-kill-v30";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260731-shade-svg-kill-v30";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260731-shade-svg-kill-v30";
