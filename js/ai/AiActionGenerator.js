...
import { getLightningStatusStateBranches } from "./lightningScoring.js?build=20260814-guardian-aid-discard";
import { getSealStatusStateBranches } from "./sealScoring.js?build=20260814-guardian-aid-discard";
import {
  ACTIVE_SKILLS, getActiveSkill, getActiveSkillCost
} from "../generals/skillRegistry.js?build=20260814-guardian-aid-discard";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260814-guardian-aid-discard";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260814-guardian-aid-discard";
