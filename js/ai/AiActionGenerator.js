...
import { getLightningStatusStateBranches } from "./lightningScoring.js?build=20260810-ruletext-v143";
import { getSealStatusStateBranches } from "./sealScoring.js?build=20260810-ruletext-v143";
import {
  ACTIVE_SKILLS, getActiveSkill, getActiveSkillCost
} from "../generals/skillRegistry.js?build=20260810-ruletext-v143";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260810-ruletext-v143";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260810-ruletext-v143";
