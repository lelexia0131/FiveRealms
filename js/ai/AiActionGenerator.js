...
import { ACTIVE_SKILLS, getActiveSkill } from "../generals/skillRegistry.js?build=20260730-tabletop-hands-v18";
...
export class AiActionGenerator {
  ...
  generate(player) {
    ...
    for (const card of player.hand) {
      ...
      if (["singleEnemy", "singleEnemyInRange", "otherWithCards"].includes(card.targetType)) {
