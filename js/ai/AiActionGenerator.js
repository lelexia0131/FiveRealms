...
import { getLightningStatusStateBranches } from "./lightningScoring.js?build=20260812-owner-ledger-v171";
import { getSealStatusStateBranches } from "./sealScoring.js?build=20260812-owner-ledger-v171";
import {
  ACTIVE_SKILLS, getActiveSkill, getActiveSkillCost
} from "../generals/skillRegistry.js?build=20260812-owner-ledger-v171";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260812-owner-ledger-v171";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260812-owner-ledger-v171";
