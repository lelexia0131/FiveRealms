...
import { ACTIVE_SKILLS, getActiveSkill } from "../generals/skillRegistry.js?build=20260804-all-in-availability-v59";
import { CARD_DEFINITIONS } from "../config/cardConfig.js?build=20260804-all-in-availability-v59";
import { buildTransferCandidates, chooseBestPositiveTransfer } from "./transferScoring.js?build=20260804-all-in-availability-v59";
...
} from "./AiProbabilityBranches.js?build=20260804-all-in-availability-v59";
