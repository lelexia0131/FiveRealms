 ...
 */
import { CARD_DEFINITIONS, TOTAL_CARD_COUNT } from "../config/cardConfig.js?build=20260804-all-in-availability-v59";
...
import { globalBenefitCounterDesire } from "./AiGlobalBenefit.js?build=20260804-all-in-availability-v59";
import {
  PROBABILITY_EPSILON,
