 ...
 */
import { CARD_DEFINITIONS, TOTAL_CARD_COUNT } from "../config/cardConfig.js?build=20260805-expose-weakness-response-v82";
...
import { globalBenefitCounterDesire } from "./AiGlobalBenefit.js?build=20260805-expose-weakness-response-v82";
import { chooseBestResourceHandCandidate, chooseResourceZone } from "./resourceSelectionValue.js?build=20260805-expose-weakness-response-v82";
...
} from "./AiProbabilityBranches.js?build=20260805-expose-weakness-response-v82";
