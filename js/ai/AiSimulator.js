 ...
 */
import { CARD_DEFINITIONS, TOTAL_CARD_COUNT } from "../config/cardConfig.js?build=20260810-discard-marginal-value-v152";
...
import { ACTIVE_SKILLS, getActiveSkillCost } from "../generals/skillRegistry.js?build=20260810-discard-marginal-value-v152";
import { getLightningStatusStateBranches, lightningPresenceProbability } from "./lightningScoring.js?build=20260810-discard-marginal-value-v152";
import { getSealStatusStateBranches, sealPresenceProbability } from "./sealScoring.js?build=20260810-discard-marginal-value-v152";
import { globalBenefitCounterDesire } from "./AiGlobalBenefit.js?build=20260810-discard-marginal-value-v152";
import { chooseBestResourceHandCandidate, chooseResourceZone } from "./resourceSelectionValue.js?build=20260810-discard-marginal-value-v152";
