 ...
 * 不读取未知牌定义，也不包含角色差值副本。
 */
import { getRoleCardAiValue } from "./roleCardValue.js?build=20260810-shield-state-value-v167";
import { UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260810-shield-state-value-v167";
