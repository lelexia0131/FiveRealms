 ...
 * 不读取未知牌定义，也不包含角色差值副本。
 */
import { getRoleCardAiValue } from "./roleCardValue.js?build=20260813-ai-hotpath-reuse";
import { UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260813-ai-hotpath-reuse";
