...
import { cardAvailability, roleCardDelta } from "./CardValue.js?build=20260815-card-estimate-parity-fix";
import {
  ENERGY_STATE_WEIGHT,
  HP_VALUE,
...
import {
  ...
  shieldStateValue
} from "./ThreatValue.js?build=20260815-card-estimate-parity-fix";
