...
import { buildTransferCandidates, chooseBestPositiveTransfer, chooseTransferHandCandidate, UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260805-ai-tactic-counter-risk-v86";
import { getRoleCardAiValue } from "./roleCardValue.js?build=20260805-ai-tactic-counter-risk-v86";
import {
  chooseBestResourceHandCandidate,
  chooseResourceZone,
  getResourceDefinitionUtility,
  getResourceUnknownUtility
} from "./resourceSelectionValue.js?build=20260805-ai-tactic-counter-risk-v86";
