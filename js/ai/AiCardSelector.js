...
import { buildTransferCandidates, chooseBestPositiveTransfer, chooseTransferHandCandidate, UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260810-global-turn-reactive-v150";
import { getRoleCardAiValue } from "./roleCardValue.js?build=20260810-global-turn-reactive-v150";
import {
  chooseBestResourceHandCandidate,
  chooseResourceZone,
  getResourceDefinitionUtility,
  getResourceUnknownUtility
} from "./resourceSelectionValue.js?build=20260810-global-turn-reactive-v150";
