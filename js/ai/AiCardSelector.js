...
import { buildTransferCandidates, chooseBestPositiveTransfer, chooseTransferHandCandidate, UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260813-blade-walker-planning";
import { getEquipmentKeepValueDeduction, getRoleCardAiValue } from "./roleCardValue.js?build=20260813-blade-walker-planning";
import {
  chooseBestResourceHandCandidate,
  chooseResourceZone,
  getResourceDefinitionUtility,
  getResourceUnknownUtility
} from "./resourceSelectionValue.js?build=20260813-blade-walker-planning";
