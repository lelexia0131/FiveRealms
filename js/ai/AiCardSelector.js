...
import { buildTransferCandidates, chooseBestPositiveTransfer, chooseTransferHandCandidate, UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260809-coordination-target-audit-v138";
import { getRoleCardAiValue } from "./roleCardValue.js?build=20260809-coordination-target-audit-v138";
import {
  chooseBestResourceHandCandidate,
  chooseResourceZone,
  getResourceDefinitionUtility,
  getResourceUnknownUtility
} from "./resourceSelectionValue.js?build=20260809-coordination-target-audit-v138";
