...
import { buildTransferCandidates, chooseBestPositiveTransfer, chooseTransferHandCandidate, UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260805-expose-weakness-response-v82";
import { getRoleCardAiValue } from "./roleCardValue.js?build=20260805-expose-weakness-response-v82";
import {
  chooseBestResourceHandCandidate,
  chooseResourceZone,
  getResourceDefinitionUtility,
  getResourceUnknownUtility
} from "./resourceSelectionValue.js?build=20260805-expose-weakness-response-v82";
