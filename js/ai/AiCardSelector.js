...
import { buildTransferCandidates, chooseBestPositiveTransfer, chooseTransferHandCandidate, UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260810-shield-state-value-v167";
import { getEquipmentKeepValueDeduction, getRoleCardAiValue } from "./roleCardValue.js?build=20260810-shield-state-value-v167";
import {
  chooseBestResourceHandCandidate,
  chooseResourceZone,
  getResourceDefinitionUtility,
  getResourceUnknownUtility
} from "./resourceSelectionValue.js?build=20260810-shield-state-value-v167";
