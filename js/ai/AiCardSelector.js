...
import { buildTransferCandidates, chooseBestPositiveTransfer, chooseTransferHandCandidate, UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260809-delayed-tactic-counter-v132";
import { getRoleCardAiValue } from "./roleCardValue.js?build=20260809-delayed-tactic-counter-v132";
import {
  chooseBestResourceHandCandidate,
  chooseResourceZone,
  getResourceDefinitionUtility,
  getResourceUnknownUtility
} from "./resourceSelectionValue.js?build=20260809-delayed-tactic-counter-v132";
