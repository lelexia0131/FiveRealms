...
import { buildTransferCandidates, chooseBestPositiveTransfer, chooseTransferHandCandidate, UNKNOWN_HAND_EXPECTED_VALUE } from "./transferScoring.js?build=20260807-human-seat-equal-height-v112";
import { getRoleCardAiValue } from "./roleCardValue.js?build=20260807-human-seat-equal-height-v112";
import {
  chooseBestResourceHandCandidate,
  chooseResourceZone,
  getResourceDefinitionUtility,
  getResourceUnknownUtility
} from "./resourceSelectionValue.js?build=20260807-human-seat-equal-height-v112";
