...
*/
import { getDistance } from "../../domain/rules/distance/DistanceRules.js?build=20260817-architecture-closure-final";
import { projectRulePlayers } from "./RuleProjection.js?build=20260817-architecture-closure-final";
