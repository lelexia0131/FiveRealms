...
const card = (definition) => Object.freeze({
  ...
  counterScope: "card", ignoresDistance: false, selectionFlow: [], ...definition
});
...
export const CARD_DEFINITIONS = Object.freeze(
  {
    ...
    recover: card({
      ...
      categoryName: "基础牌",
      usageMode: "both",
      responseTypes: ["dyingRescue"],
      targetType: "self",
      subtypes: ["heal", "rescue"],
      description: "出牌阶段令自己恢复1点生命；濒死时可救援自己或队友。",
      count: 12,
      aiValue: 6,
    ...
    block: card({
      ...
      subtypes: ["defense", "response"],
      description: "使用要求数量的格挡，令该次攻击无效。",
      count: 20,
      aiValue: 5,
    ...
    scout: card({
      ...
      subtypes: ["information", "hidden-selection"],
      description: "查看一名其他角色至多2张指定手牌。",
      count: 6,
      aiValue: 5,
      ignoresDistance: true,
      selectionFlow: ["target", "hiddenCards:upTo2"],
    ...
    transfer: card({
      ...
      subtypes: ["control", "hidden-selection"],
      description: "选择距离1内一名拥有手牌的来源和一名不同接收者，将其中1张手牌转移至接收者手牌；不能转移装备区的牌。",
      count: 2,
      aiValue: 6,
      effectRange: 1,
      targetZones: ["hand"],
      selectionFlow: ["source", "receiver", "handCard:1"],
    ...
    exposeWeakness: card({
      ...
      categoryName: "战术牌",
      targetType: "self",
      subtypes: ["status", "attack-buff"],
      description: "获得1层破势；破势可以使突袭伤害额外增加相应的破势层数；破势层数可叠加，打出突袭后消耗所有层数。",
      count: 6,
      aiValue: 6,
    ...
    shockwave: card({
      ...
      subtypes: ["attack", "assault", "area"],
      description: "对所有敌人进行1次突袭；目标反制时只取消对自己的效果。",
      count: 3,
      aiValue: 8,
      counterScope: "target",
      ignoresDistance: true,
    ...
    provoke: card({
      ...
      categoryName: "战术牌",
      targetType: "allEnemies",
      subtypes: ["coercion", "damage"],
      description: "每名敌人打出1张突袭，否则受到1点伤害。",
      count: 3,
      aiValue: 8,
      counterScope: "target",
      ignoresDistance: true,
    ...
    leverage: card({
      ...
      categoryName: "战术牌",
      targetType: "multiStage",
      subtypes: ["coercion", "assault", "equipment-control"],
      description: "选择一名装备区有装备的其他玩家，以及其能够突袭的另一名玩家。令前者对后者使用一张突袭；若其拒绝，则你获得该装备。",
      count: 3,
      aiValue: 7,
      selectionFlow: ["firstTarget", "equipment", "secondTarget", "confirm"],
    ...
    plunder: card({
      ...
      subtypes: ["control", "hidden-selection", "equipment-control"],
      description: "获得距离2内一名其他角色的1张指定手牌或装备牌。",
      count: 5,
      aiValue: 7,
      effectRange: 2,
      targetZones: ["hand", "equipment"],
      selectionFlow: ["target", "zoneCard:1"],
    ...
    counter: card({
      ...
      categoryName: "战术牌",
      usageMode: "response",
      responseTypes: ["counter"],
      targetType: "responseOnly",
      subtypes: ["response", "counter"],
    ...
    duel: card({
      ...
      subtypes: ["duel", "attack-discard"],
      description: "目标先开始，双方轮流打出突袭；首先放弃者受到1点伤害。",
      count: 3,
      aiValue: 6,
      ignoresDistance: true,
    ...
    defenseDevice: card({
      ...
      description: "遭受突袭或震荡前判定：战术牌令攻击无效；基础牌进入手牌后继续结算；装备牌则判定失败。",
      count: 2,
      aiValue: 9,
      counterable: false,
    ...
    battleDevice: card({
      ...
      categoryName: "装备牌",
      targetType: "self",
      subtypes: ["equipment", "attack"],
      description: "你的突袭与震荡需要目标一次使用2张格挡才能防御；数量不足时不会消耗已有格挡。",
      count: 2,
      aiValue: 9,
      counterable: false,
    ...
    telescope: card({
      ...
      categoryName: "装备牌",
      targetType: "self",
      subtypes: ["equipment", "distance", "attack"],
    ...
    barrierDevice: card({
      ...
      categoryName: "装备牌",
      targetType: "self",
      subtypes: ["equipment", "distance", "defense"],
