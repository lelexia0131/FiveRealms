...
export const GENERAL_DEFINITIONS = Object.freeze([
  Object.freeze({
    ...
    loreFaction: "流火长路", maxHp: 4, tags: ["输出", "爆发"], roleTags: ["damage", "attacker"], passiveSkillIds: ["momentum"], activeSkillIds: ["breakArmy"],
  ...
  Object.freeze({
    ...
    loreFaction: "无灯港", maxHp: 4, tags: ["控制", "辅助"], roleTags: ["control", "utility"], passiveSkillIds: ["spyGap"], activeSkillIds: ["stealSkill"],
  ...
  Object.freeze({
    ...
    loreFaction: "苍苔原", maxHp: 4, tags: ["突破", "爆发"], roleTags: ["damage", "control"], passiveSkillIds: ["tracking"], activeSkillIds: ["hunt"],
  ...
  Object.freeze({
    ...
    loreFaction: "鸣风塔", maxHp: 4, tags: ["过牌", "辅助"], roleTags: ["support", "control"], passiveSkillIds: ["coordination"], activeSkillIds: ["resonance"],
