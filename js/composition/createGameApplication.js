...
import { AI_RUNTIME_POLICY } from "../ai/policy/AiRuntimePolicy.js?build=20260817-architecture-closure-final";
...
import { EventDispatcher } from "../application/messaging/EventDispatcher.js?build=20260817-architecture-closure-final";
import { Player } from "../application/match/Player.js?build=20260817-architecture-closure-final";
import { Deck } from "../application/match/Deck.js?build=20260817-architecture-closure-final";
import { TeamAssignment } from "../application/match/TeamAssignment.js?build=20260817-architecture-closure-final";
import { CharacterSelection } from "../application/match/CharacterSelection.js?build=20260817-architecture-closure-final";
import { createTeamRuleQueries } from "../application/match/TeamRuleQueries.js?build=20260817-architecture-closure-final";
import { ActionLegality } from "../application/action/ActionLegality.js?build=20260817-architecture-closure-final";
import { createResponseWorkflow } from "../application/response/ResponseWorkflow.js?build=20260817-architecture-closure-final";
import { MatchLogAdapter } from "../adapters/ui/MatchLogAdapter.js?build=20260817-architecture-closure-final";
import { canUseActiveSkill, getActiveSkill, getActiveSkillCost } from "../application/action/SkillRuntime.js?build=20260817-architecture-closure-final";
import { AIController } from "../ai/AiController.js?build=20260817-architecture-closure-final";
import { hashSearchSeed, SearchRng } from "../ai/search/SearchRng.js?build=20260817-architecture-closure-final";
import { createSearchExecutor } from "../adapters/ai/worker/createSearchExecutor.js?build=20260817-architecture-closure-final";
import { CleanupManager } from "../utils/CleanupManager.js?build=20260817-architecture-closure-final";
...
import { createDyingWorkflow } from "../application/combat/DyingWorkflow.js?build=20260817-architecture-closure-final";
import { createJudgmentWorkflow } from "../application/judgment/JudgmentWorkflow.js?build=20260817-architecture-closure-final";
import { createStatusResolutionWorkflow } from "../application/judgment/StatusResolutionWorkflow.js?build=20260817-architecture-closure-final";
import { HiddenCardSelectionAdapter } from "../adapters/ui/HiddenCardSelectionAdapter.js?build=20260817-architecture-closure-final";
import { createHiddenCardChoiceWorkflow } from "../application/action/HiddenCardChoiceWorkflow.js?build=20260817-architecture-closure-final";
import { createChoiceBoundary } from "./createChoiceBoundary.js?build=20260817-architecture-closure-final";
import { createRandomPort } from "../application/ports/RandomPort.js?build=20260817-architecture-closure-final";
import { createGamePresentationAdapter } from "../adapters/ui/GamePresentationAdapter.js?build=20260817-architecture-closure-final";
import { createPlayerStatisticsDiagnosticsAdapter } from "../adapters/diagnostics/PlayerStatisticsDiagnosticsAdapter.js?build=20260817-architecture-closure-final";
import { createRecentAggressorsObservationAdapter } from "../adapters/ai/RecentAggressorsObservationAdapter.js?build=20260817-architecture-closure-final";
import { createCombatWorkflow } from "../application/combat/CombatWorkflow.js?build=20260817-architecture-closure-final";
import { createMatchWorkflow } from "../application/match/MatchWorkflow.js?build=20260817-architecture-closure-final";
import { createTurnWorkflow } from "../application/turn/TurnWorkflow.js?build=20260817-architecture-closure-final";
import { createActionWorkflow } from "../application/action/ActionWorkflow.js?build=20260817-architecture-closure-final";
import { createCardRuntime } from "../application/action/CardRuntime.js?build=20260817-architecture-closure-final";
import { getActionLogMessage as getActionLogMessageFromRuntime, getActionTargetLabel as getActionTargetLabelFromRuntime, resolveActionDisplayTargets, shouldSuppressUseLog as shouldSuppressUseLogFromRuntime } from "../application/action/ActionPresentation.js?build=20260817-architecture-closure-final";
import { createCardIntentRuntime } from "../application/action/CardIntentRuntime.js?build=20260817-architecture-closure-final";
import { isTransferExecutionAllowed } from "../adapters/ai/TransferExecutionPolicyAdapter.js?build=20260817-architecture-closure-final";
import { createCardEffectRuntime } from "../application/action/CardEffectRuntime.js?build=20260817-architecture-closure-final";
import { createSkillEffectRuntime } from "../application/action/SkillEffectRuntime.js?build=20260817-architecture-closure-final";
import { createPassiveSkillTriggerRegistry } from "../application/trigger/PassiveSkillTriggerRegistry.js?build=20260817-architecture-closure-final";
import { createRecycleDeviceTrigger } from "../application/trigger/RecycleDeviceTrigger.js?build=20260817-architecture-closure-final";
import { createGlobalTriggerRegistry } from "../application/trigger/GlobalTriggerRegistry.js?build=20260817-architecture-closure-final";
import { PublicCardPoolWorkflow } from "../application/action/PublicCardPoolWorkflow.js?build=20260817-architecture-closure-final";
import { createResourceWorkflow } from "../application/action/ResourceWorkflow.js?build=20260817-architecture-closure-final";
import { createCardKnowledgeAdapter } from "../adapters/ai/CardKnowledgeAdapter.js?build=20260817-architecture-closure-final";
import { createMatchState } from "../domain/state/model/MatchState.js?build=20260817-architecture-closure-final";
import { getCurrentActor, getAllies as getAlliesFromState, getEnemies as getEnemiesFromState, getSeatOrderFrom } from "../domain/state/queries/MatchQueries.js?build=20260817-architecture-closure-final";
import { addTrackingTarget, markCategoryUsed, setGuardianAidUsed, setKillRewardGranted, setLastEmberResolutionId, setMomentum, setSpyGapPendingTargetIds, setTrackingTurnNumber } from "../domain/state/transitions/RuleUsageTransitions.js?build=20260817-architecture-closure-final";
